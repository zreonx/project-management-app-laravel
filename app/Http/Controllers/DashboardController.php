...
class DashboardController extends Controller
{
    public function index() {
        ...
        $activeTasks = Task::query()->where('status', ['pending', 'in_progress'])->where('assigned_user_id', $user->id)->limit(10)->get();

        $activeTasks = TaskResource::collection($activeTasks);

        return inertia('Dashboard', compact('totalTasks', 'activeTasks', 'totalPendingTasks', 'myPendingTasks', "totalProgressTasks", "myProgressTasks", "totalCompletedTasks", "myCompletedTasks"));
    }
}
